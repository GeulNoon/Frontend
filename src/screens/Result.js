...
function Result() {
    ...
    useEffect(() => {
      ...
      const response = await axios.get(`https://www.geulnoon.com/api/getHistory`, {params: {'email': sessionStorage.getItem('user')}});
      const stat = await axios.get(`https://www.geulnoon.com/api/getStatistics`, {params: {'email': sessionStorage.getItem('user'), 'option': option}});  
    ...
    const changeOption = async(i) => {
      setOption(i)
      const stat = await axios.get(`https://www.geulnoon.com/api/getStatistics`, {params: {'email': sessionStorage.getItem('user'), 'option': i}});
      setStatistics(stat.data) 
    }
   return (
